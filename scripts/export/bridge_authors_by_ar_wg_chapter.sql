...
SELECT
  ...
  role_ratios.responsibility * 100 AS '% Responsibility Roles',
  role_ratios.cla * 100 AS '% CLA',
  role_ratios.la * 100 AS '% LA',
  role_ratios.re * 100 AS '% RE',
  role_ratios.ca * 100 AS '% CA',
